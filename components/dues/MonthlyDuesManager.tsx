        ...
        >
          <div className="flex items-center justify-between">
            ...
            {summary.overdueCount > 0 && (
              <span className="text-[9px] sm:text-[10px] font-mono font-bold px-1.5 py-0.5 bg-zinc-900 text-white rounded">
        ...
        {reminders.length === 0 ? (
          <div className="py-8 text-center space-y-2 bg-zinc-50 rounded-xl border border-dashed border-zinc-200 p-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onOpenAddModal}
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-black text-white text-xs font-semibold rounded-lg hover:bg-zinc-800 transition-colors cursor-pointer"
            >
